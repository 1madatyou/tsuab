    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_ru', models.CharField(max_length=255, null=True, verbose_name='Тема')),
                ('title_en', models.CharField(max_length=255, null=True, verbose_name='Тема')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='materials.educationalmaterial')),
            ],
            options={
                'verbose_name': 'файл',
